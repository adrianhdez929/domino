...
class Program {
    static void Main() {
        ...
        int tokensAmount = SetTokensPerPlayer(value, playerCount);
        DominoPlayer[] players = SetPlayers(playerCount, value);
    ...
    static int SetTokensPerPlayer(int tokenValue, int playerCount) {
    ...
    static DominoPlayer[] SetPlayers(int playerCount, int tokenValue) {
    ...
    static void PrepareGame(
        int tokenValue, int tokensPerPlayer, 
        DominoToken token, 
        DominoPlayer[] players, 
        IWinner winner, IWinCondition win
    ) {
